    ...
    <div className="flex flex-wrap items-center gap-2 mb-6">
      ...
      <div className="relative">
        ...
        <input
          ...
          placeholder="Search…"
          className="w-44 bg-[#18181b] border border-[#27272a] focus:border-[#52525b] text-sm text-white placeholder-[#52525b] rounded-lg pl-8 pr-7 py-1.5 outline-none transition-colors text-[13px]"
        />
        {search && (
          <button
      ...
      {/* Event count */}
      <div className="ml-auto text-[11px] text-[#52525b]">
