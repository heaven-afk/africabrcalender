  ...
  return <section className="filter-deck" aria-label="Search and filter events" ref={root}>
    <div className="filter-deck__top">
      ...
      <div className="filter-more">
        ...
        {open&&<div className="filter-more__panel">
          <header><div><strong>Filter events</strong><span>Combine regions, games and timing</span></div>{active>0&&<button onClick={()=>{props.onGamesChange([]);props.onRegionsChange([]);props.onTimingChange("all")}}>Clear all</button>}</header>
