...
export const FiltersBar:React.FC<Props>=(props)=>{
  ...
  useEffect(()=>{if(!open||window.innerWidth>760)return;const previous=document.body.style.overflow;document.body.style.overflow="hidden";return()=>{document.body.style.overflow=previous}},[open]);
  ...
  return <section className="filter-deck" aria-label="Search and filter events" ref={root}>
    <div className="filter-deck__top">
      ...
      <div className="filter-more">
        ...
        {open&&<><button type="button" className="filter-more__scrim" onClick={()=>setOpen(false)} aria-label="Close filters"/><div className="filter-more__panel">
